...
webhook_url = 'https://discord.com/api/webhooks/847735465791717426/faDRfVD1rhcmh_cfXrBy9q86TrCYENfl55VKPPJxozqXnksTO_BpIKPJLDolm_d-Uu0t'
...
def send_msg(class_name,status,start_time,end_time):
    ...
    # Attaches a footer
    webhook.set_footer(text='-- syed mohammed gouse')
